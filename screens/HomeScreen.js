import {Share, StyleSheet ,View, Text, Image, TextInput, TouchableOpacity, ScrollView, ImageBackground, Dimensions } from 'react-native'
      ...
      <View className="flex-1 relative">
        ...
        >
          ...
          <View style={styles.slide}>
            <Image 
              blurRadius={0} 
              source={require('../assets/images/map2.webp')} 
              className="absolute w-full h-full" 
